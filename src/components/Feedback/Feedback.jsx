...
import { submitFeedback } from '../../redux/features/feedbackSlice/feedbackSlice';
...
const Feedback = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (submitFeedback.fulfilled.match(result)) {
      openModal("success", result.payload.message || "Feedback submitted successfully!");
      setFormData({ name: '', email: '', message: '' });
    } else {
      openModal("error", result.payload || "Error submitting feedback");
    }
  };
  ...
  return (
   ...
   <form className="flex flex-col gap-4 text-base text-gray-700" onSubmit={handleSubmit}>
          <label className="flex flex-col font-medium">
            ...
            <input
              ...
              required
              className="mt-1 px-4 py-3 border border-gray-300 rounded-md"
            />
          </label>
          ...
          <label className="flex flex-col font-medium">
            ...
            <textarea
              ...
              rows={6}
              required
              className="mt-1 px-4 py-3 border border-gray-300 rounded-md resize-none"
            />
          </label>
